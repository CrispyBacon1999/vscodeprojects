...
public class DrivetrainSubsystem extends SubsystemBase {
  ...
  private Pose2d m_field_centric_pose = new Pose2d(new Translation2d(0, 0), new Rotation2d(0));
  ...
  public void updateOdometry(SwerveModuleState[] states) {
    m_odometry.update(
        Rotation2d.fromDegrees(getGyroscopeRotation().getDegrees()),
        states[0],
        states[1],
        states[2],
        states[3]);
  ...
  public void setFieldPosition(Translation2d translation, Rotation2d rotation) {
    m_field_centric_pose = new Pose2d(translation, rotation);
  }

  public Pose2d getFieldPose2d() {
    Pose2d robotPose = getPose2d();

    // Add robot pose to field start pose
    return new Pose2d(robotPose.getTranslation().plus(m_field_centric_pose.getTranslation()),
        robotPose.getRotation().plus(m_field_centric_pose.getRotation()));
  }
